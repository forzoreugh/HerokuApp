...
public class HoversTest {
    ...
    public void сheckProfile(){
        ...
        softAssert.assertEquals(nameUser1.getText(), "name: user1");
        ...
        softAssert.assertTrue(errorTextUser1.isDisplayed());
        ...
        softAssert.assertEquals(nameUser2.getText(), "name: user2");
        ...
        softAssert.assertTrue(errorTextUser2.isDisplayed());
        ...
        softAssert.assertEquals(nameUser3.getText(), "name: user3");
        ...
        softAssert.assertTrue(errorTextUser3.isDisplayed());
    }
